...
public class MainActivity extends Activity {
	...
	private final String navigationDrawerItems[] = { "Home", "Schedule",
			"Abstracts", "Map", "Notes", "Itenerary Planner", "News Feed",
			"General Information" };
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mDrawerList.setAdapter(new ArrayAdapter<String>(this,
				android.R.layout.simple_list_item_1, navigationDrawerItems));
